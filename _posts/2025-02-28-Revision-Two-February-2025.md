...
Having not programmed in a long time it was a nice re-introduction. Though most of the exercises were not challenging, it was good practice to aid my memory. It was also my first time using typed Python, which I think is a good thing and will definitely use in the future.

## MIT OpenCourseWare 6.001L
**20 Hours**

This is another good introduction to programming. Unlike the Helsinki MOOC which introduced programming through multiple repeated exercises to drill in the concepts, this was more theoretical. There were programming assignments, and unit tests to help know if you solved an assignment correctly. There was a bit of hassle as the Python version I was using had deprecated one of the functions in the unit tests, but using UV to install an older version of Python in a environment for the course meant they worked fine.
